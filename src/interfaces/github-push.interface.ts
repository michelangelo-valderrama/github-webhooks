// To parse this data:
//
//   import { Convert, GitHubPushPayload } from "./file";
//
//   const gitHubPushPayload = Convert.toGitHubPushPayload(json);
//
...
class Convert {
  public static toGitHubPushPayload(json: string): GitHubPushPayload {
      return cast(JSON.parse(json), r("GitHubPushPayload"));
  }

  public static gitHubPushPayloadToJson(value: GitHubPushPayload): string {
      return JSON.stringify(uncast(value, r("GitHubPushPayload")), null, 2);
  }
}
...
const typeMap: any = {
  "GitHubPushPayload": o([
      ...
      { json: "pusher", js: "pusher", typ: r("Pusher") },
      { json: "sender", js: "sender", typ: r("Sender") },
      { json: "created", js: "created", typ: true },
      { json: "deleted", js: "deleted", typ: true },
      { json: "forced", js: "forced", typ: true },
      { json: "base_ref", js: "base_ref", typ: null },
      { json: "compare", js: "compare", typ: "" },
      { json: "commits", js: "commits", typ: a(r("Commit")) },
      { json: "head_commit", js: "head_commit", typ: r("Commit") },
  ], false),
  "Commit": o([
      { json: "id", js: "id", typ: "" },
      { json: "tree_id", js: "tree_id", typ: "" },
      { json: "distinct", js: "distinct", typ: true },
      { json: "message", js: "message", typ: "" },
      { json: "timestamp", js: "timestamp", typ: Date },
      { json: "url", js: "url", typ: "" },
      { json: "author", js: "author", typ: r("Author") },
      { json: "committer", js: "committer", typ: r("Author") },
      { json: "added", js: "added", typ: a("") },
      { json: "removed", js: "removed", typ: a("any") },
      { json: "modified", js: "modified", typ: a("") },
  ], false),
  "Author": o([
  ...
  "Repository": o([
      ...
      { json: "pushed_at", js: "pushed_at", typ: 0 },
      ...
      { json: "stargazers", js: "stargazers", typ: 0 },
      { json: "master_branch", js: "master_branch", typ: "" },
  ], false),
  "Sender": o([
